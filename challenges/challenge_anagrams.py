...
def merge(left, right, merged):
    ...
    # Conteúdo retirado do Course
    # Bloco 36 - Algoritmos de Ordenação: Merge Sort
...
def is_anagram(first_string, second_string):
    ...
    first_string_sorted = merge_sort([letter for letter in first_string])
    second_string_sorted = merge_sort([letter for letter in second_string])
